...
function mountDashboardCharts() {
  ...
  // Chart 4: Evolución Inversión
  const ctx4 = document.getElementById("chart-timeline");
  if (ctx4 && typeof Chart !== "undefined") {
    chartInstances.timeline = new Chart(ctx4, {
      type: "line",
      data: {
        labels: ["Ene 2026", "Feb 2026", "Mar 2026 (Actual)", "Abr 2026 (Proy)", "May 2026 (Proy)", "Jun 2026 (Proy)"],
        datasets: [
          {
            label: "Gasto Acumulado ($)",
            data: [120000, 480000, 846900, 1020000, 1110000, 1130000],
            borderColor: "#10b981",
